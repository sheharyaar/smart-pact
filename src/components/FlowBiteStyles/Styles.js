...
const formTheme = {
    "checkbox": {
      "root": {
        ...
        "color": {
          "default": "focus:ring-purple-600 dark:ring-offset-purple-600 dark:focus:ring-purple-600 text-purple-600",
    ...
    "textInput": {
      "base": "flex",
      "addon": "inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-200 px-3 text-base text-gray-900 dark:border-gray-600 dark:bg-gray-600 dark:text-gray-400",
      "field": {
        "base": "relative w-full",
        "icon": {
...
const buttonTheme = {
    ...
    "color": {
      ...
      "purple": " text-xl text-white bg-purple-700 border border-transparent enabled:hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 dark:bg-purple-600 dark:enabled:hover:bg-purple-700 dark:focus:ring-purple-900",
    ...
    "label": "ml-2 inline-flex h-4 w-4 items-center justify-center rounded-full bg-cyan-200 font-semibold text-cyan-800",
    "outline": {
      "color": {
...
export { tabTheme, cardTheme, formTheme, buttonTheme , dropdownTheme};
